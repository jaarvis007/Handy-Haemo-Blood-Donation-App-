  ...
  return (
    ...
    <ScrollView>
      <View>
        ...
        <View><Text style={[commonStyle({fontSize:25,color:colorValue.liteDark3}).text,commonJustify.textCenter]}>{userDetail.name}</Text></View>
        <View style={[commonJustify.rowCenter,{marginVertical:10}]}><Icon name="map"/><Text style={[commonStyle({fontSize:15,color:colorValue.liteDark3}).text,commonJustify.textCenter]}>{userDetail.location}</Text></View>
        ...
        <View style={commonJustify.rowSpaceEvenly}>
              <View style={style.card}>
                <Text style={[commonStyle({fontSize:24,fontFamily:fontValue.PoninsBold}).text,{textAlign:'center'}]}>{userDetail.bloodtype}</Text>
        ...
        <View style={{marginVertical:15}}>
              <ListItem containerStyle={[{marginTop:10 },{marginHorizontal:10}]}bottomDivider>

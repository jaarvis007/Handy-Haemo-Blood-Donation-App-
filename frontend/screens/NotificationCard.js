...
const NotificationCard = ({ item }) => {
    ...
    if (item.status === 'accept') {
        return (
            <TouchableOpacity style={[styles.acceptmain, commonJustify.rowSpaceBetween]}>
                <Avatar
                    rounded
                    size={'medium'}
        ...
        return (
            <TouchableOpacity style={[styles.rejectmain, commonJustify.rowSpaceBetween,]}>
                <Avatar
                    rounded
                    size={'medium'}
                    icon={{ name: 'user', type: 'font-awesome' }}
